...
export default async function NewApplicationPage({ searchParams }: { searchParams: { customerId?: string } }) {
  ...
  return (
    <div>
      <PageHeader title="New Loan Application" description="Apply for a loan on behalf of a customer" />
      <LoanApplicationForm
        customers={customers}
        branches={branches}
